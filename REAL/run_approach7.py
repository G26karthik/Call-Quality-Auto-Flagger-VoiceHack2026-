...
print("--- APPROACH 7: Fine-Tuned Micro Rules (Target F1 >= 0.50) ---")
...
sub_v7 = pd.DataFrame({'call_id': test['call_id'], 'has_ticket': preds_test.astype(int)})
sub_v7.to_csv('REAL/submission_v7.csv', index=False)
print(f"SUCCESS! Created submission_v7.csv with {preds_test.sum()} flagged.")
